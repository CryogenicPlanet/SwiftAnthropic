...
public struct MessageParameter: Encodable {
   ...
   public struct Tool: Codable, Equatable {
      ...
      /// The width of the display in pixels (for computer type tools).
      public let displayWidthPx: Int?
      /// The height of the display in pixels (for computer type tools).
      public let displayHeightPx: Int?
      /// The display number (for computer type tools).
